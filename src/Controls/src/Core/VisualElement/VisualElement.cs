...
After:
		static void FlowDirectionChanging()
*/
...
After:
		static void FlowDirectionChanged(double value)
*/
...
After:
		static object CoerceIsEnabledProperty(object? sender, PropertyChangedEventArgs e)
*/
